...
public void limpiar()
    ...
    private void regproveedorjButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_regproveedorjButton9ActionPerformed
          ...
          ProveedorDAO vendedorDAO = new ProveedorDAO();
        Proveedor vendedorAInsertar = new Proveedor();
        vendedorAInsertar.setNo_documento(documentoproveedorjTextField9.getText());
        vendedorAInsertar.setCod_tipo_documento(combo_tipo.getSelectedItem().toString());
         vendedorAInsertar.setNombre(nomproveedorjTextField9.getText());
        vendedorAInsertar.setApellido(apellproveedorjTextField9.getText());
        vendedorAInsertar.setNombre_comercial(nomcomercialjTextField10.getText());
        vendedorAInsertar.setDireccion(dirproveedorjTextField9.getText());
        vendedorAInsertar.setCod_ciudad(ciudad_combo.getSelectedItem().toString());
        vendedorAInsertar.setTelefono(telefonoprovjTextField9.getText());
